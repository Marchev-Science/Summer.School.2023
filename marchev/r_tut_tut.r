...
# Load the data
data <- read_xlsx() # <- complete the code here
# Data preparation
...
# complete the code to extract data TimeT and Y
data <- data[]
data
...
working_SMA <- as.data.frame(shift(SMA(),1)) # complete inside SMA
...
# complete code to get plot of data and forecast
